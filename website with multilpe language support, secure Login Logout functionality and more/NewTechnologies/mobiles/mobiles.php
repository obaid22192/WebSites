 ...
 #col3{padding:0px 0px 10px 50px; }
    ...
    <body>
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li>
					...
					<div class="sdt_box">
						...
						<a href="#"><?php echo $Home[$default]['mobiles']  ?></a>
      ...
      <ul class="slides">
        ...
        <li><img src="JOLLAIMAGES/1.png" /></li>
		 <li><img src="JOLLAIMAGES/2.jpg" /></li>
		  <li><img src="JOLLAIMAGES/3.jpg" /></li>
		   <li><img src="JOLLAIMAGES/4.jpg" /></li>
		 <li><img src="JOLLAIMAGES/5.jpg" /></li>
		  <li><img src="JOLLAIMAGES/6.jpg" /></li>
		   <li><img src="JOLLAIMAGES/7.jpg" /></li>
		    <li><img src="JOLLAIMAGES/8.jpg" /></li>
         <li><img src="JOLLAIMAGES/9.jpg" /></li>
	...
	<h1 id = "footertext"></h1>
	 ...
	 <div id = "div1">
	  <!--slider -->
	  <a href = "iphonechoice.php">
	   <div class="slider1">
      <ul class="slides">
        <li><img src="iphonechoiceimages/small/1.png" /></li>
		<li><img src="iphonechoiceimages/small/3.jpg" /></li>
		<li><img src="iphonechoiceimages/small/4.jpg" /></li>
          ...
          <h3><span class = "post1"><?php echo $mobile[$default][ 'heading_1']  ?></span></h3>
	 <p id = "info">



<?php echo $mobile[$default]['desc_1']  ?> <a href = "iphonechoice.php"><span><?php echo $Home[$default]['readmore']  ?></span></a> </p>
	 </div>
	 ...
	 <a href = "JOLLA.php">
      ...
      <ul class="slides">
	   ...
	   <h3><span class = "post1"><?php echo $mobile[$default][ 'heading_2']  ?></span></h3>
	 <p id = "info"><?php echo $mobile[$default]['desc_2']  ?> <a href = "JOLLA.php"><span><?php echo $Home[$default]['readmore']  ?></span></a> </p>
	  
	 </div>
	 
	 <div id = "div3">
	 <a href = "googlesearch.php">
	 <div class="slider1">
      <ul class="slides">
        <li><img src="googleimages/small/1.jpg" /></li>
		 <li><img src="googleimages/small/2.png" /></li>
		  <li><img src="googleimages/small/3.jpg" /></li>
	 ...
	 <h3><span class = "post1"><?php echo $mobile[$default]['heading_3']  ?></span></h3>
	 <p id = "info"><?php echo $mobile[$default]['desc_3']  ?>  <a href = "googlesearch.php"><span><?php echo $Home[$default]['readmore']  ?></span></a> </p>
	 </div>
