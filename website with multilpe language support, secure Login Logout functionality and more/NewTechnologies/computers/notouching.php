...
<html>
    <head>
        <title><?php  echo $NO_touch[$default]['title']; ?></title>
...
tr td:first-child {padding-left:0px;}
 ...
 #col3{padding:0px 0px 10px 50px; }
	...
	<h1 id = "footertext"> </h1>
	  ...
	  <h1 id = "bioheading" ><?php  echo $NO_touch[$default]['heading1']; ?></h1>
	  <hr />
	  <p id = "desc"> <?php  echo $NO_touch[$default]['desc1']; ?>
 </p>
 <img src="notouchingimages/1.jpg" width="500"
       height="300"  />
  <p id = "desc">
  
  <?php  echo $NO_touch[$default]['desc2']; ?>



  </p>

 <img src="notouchingimages/2.jpg" width="500"
       height="300"  />
 
      <p id = "desc">
 <?php  echo $NO_touch[$default]['desc3']; ?>

</p>
<img src="notouchingimages/7.jpg" width="500"
       height="300"  />
	   <br />
<p id = "desc">

<?php  echo $NO_touch[$default]['desc4']; ?>
