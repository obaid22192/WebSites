...
<html>
    <head>
        <title><?php echo $jolla[$default]['heading'] ?></title>
...
tr td:first-child {padding-left:0px;}
 ...
 #col3{padding:0px 0px 10px 50px; }
    ...
    <body>
	   ...
	   <div class="slider">
      <ul class="slides">
        <li><img src="JOLLAIMAGES/21.jpg" /></li>
	...
	<h1 id = "footertext"></h1>
	  ...
	  <h1 id = "bioheading" ><?php echo $jolla[$default]['heading'] ?></h1>
<hr />

		<article id="content" class="single-post" itemprop="articleBody">
			<p><?php echo $jolla[$default]['desc'] ?></p>
		</article>
