...
<html>
    <head>
        <title><?php  echo $iphonechoice[$default]['title'] ?></title>
...
tr td:first-child {padding-left:0px;}
 ...
 #col3{padding:0px 0px 10px 50px; }
    ...
    <body>
		...
		<div id = "mainpage"class="content">
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li>
					...
					<div class="sdt_box">
						<a href="../computers/computers.php"><?php echo $Home[$default]['computers']  ?></a>
						<a href="mobiles.php"><?php echo $Home[$default]['mobiles']  ?></a>
	   ...
	   <div class="slider">
      <ul class="slides">
        <li><img src="iphonechoiceimages/1.png" /></li>
		<li><img src="iphonechoiceimages/3.jpg" /></li>
		<li><img src="iphonechoiceimages/4.jpg" /></li>
		<li><img src="iphonechoiceimages/5.jpg" /></li>
	...
	<h1 id = "footertext"> </h1>
	  ...
	  <h1 id = "bioheading" ><?php  echo $iphonechoice[$default]['title'] ?></h1>
	  ...
	  <p id = "desc">
		...
		<article id="content" class="single-post" itemprop="articleBody">
			<a href="http://www.digitaltrends.com/topic/iphone-5s-iphone-5c-announcement/"><img width="280" height="75" src="http://icdn7.digitaltrends.com/image/iphone-5s-5c-280x75-c.png" class="dtt-topic-banner alignright" alt="iphone-5s-5c" /></a><p>The <a href="http://www.digitaltrends.com/topic/iphone-5s-iphone-5c-announcement/"><?php  echo $iphonechoice[$default]['desc1'] ?></p>
<h3<?php  echo $iphonechoice[$default]['heading_2'] ?></h3>
<p><strong>Winner: iPhone 5C</strong></p>
<p><?php  echo $iphonechoice[$default]['desc_2'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_3'] ?></h3>
<p><strong>Winner: iPhone 5S</strong></p>
<p><?php  echo $iphonechoice[$default]['desc_3'] ?>.</p>
<p><?php  echo $iphonechoice[$default]['desc_4'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_4'] ?></h3>
<p><strong>Winner: iPhone 5S</strong></p>
<p><?php  echo $iphonechoice[$default]['desc_5'] ?></p>
<p><?php  echo $iphonechoice[$default]['desc_6'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_5'] ?></h3>
<p><strong>Winner: iPhone 5S</strong></p>
<p><?php  echo $iphonechoice[$default]['desc_7'] ?>.</p>
<p><?php  echo $iphonechoice[$default]['desc_8'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_6'] ?></h3>
<p><?php  echo $iphonechoice[$default]['desc_9'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_7'] ?></h3>
<p><?php  echo $iphonechoice[$default]['desc_10'] ?></p>
<h3><?php  echo $iphonechoice[$default]['heading_8'] ?></h3>
<p><?php  echo $iphonechoice[$default]['desc_11'] ?></p>
		</article>
