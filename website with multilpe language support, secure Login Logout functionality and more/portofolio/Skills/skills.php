...
width: 12%;
	...
	<div id = "testtop">
             <table    border="0" style=" margin-left:70%;">
                <tr>
	...
	<div class = "whoiam" id = "id_whoIam">
	  <h1 id = "bioheading" ><?php  echo $skills[$default]['heading']  ?></h1>
	  <hr />
	  <p id = "desc">  <?php  echo $skills[$default]['desc'] ?>		  
	 ...
	 <?php else : ?>
            <p>
            <?php echo  '<span class="error">You are not authorized to access this page.</span> Please <a href="../../include/login/loginfailed.php">login</a>' ;
           
            //header('Location:../../include/login/loginfailed.php');
            ?>
            </p>
        <?php endif; ?>
