...
width: 12%;
 ...
 #col3{padding:0px 0px 10px 50px; }
		...
		<div id = "mainpage"class="content">
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li>
					...
					<div class="sdt_box">
							<a href="#"><?php echo $Home[$default]['history']  ?></a>
							<a href="../tourism/tourism.php"><?php echo $Home[$default]['tourism']  ?></a>
	...
	<div class = "whoiam" id = "id_whoIam">
	  ...
	  <h1 id = "bioheading" ><?php echo $History[$default]['history_h1'] ; ?></h1>
	  <hr />
	  <h1 id = "bioheading">Jammu Kashmir</h1>
	  <p id = "desc">
	 <?php echo $History[$default]['history_desc'] ; ?>
	  <br />
      
     </p>
	 <h1 id = "bioheading"><?php echo $History[$default]['early_history_h1'] ; ?></h1>
	  <p id = "desc">
<?php echo $History[$default][ 'early_history_desc'];  ?>
	  
	  </p>
	<h1 id = "bioheading"> <?php echo $History[$default]['kashmirbefore_h1'];  ?>7</h1>
	 <p id = "desc">
	 
           <?php echo $History[$default]['kashmir_before_1947_des'];  ?>
	 
	 <p>
	 <h1 id = "bioheading"><?php echo $History[$default]['kashmir_after'];  ?></h1>
	 <p id = "desc">
	 <?php echo $History[$default]['Kashmir_after_1947_desc']; ?>
	 </p>
	 <h1 id = "bioheading"> <?php echo $History[$default]['kashmir_today_h1']; ?></h1>
	 <p id = "desc">
	  <?php echo $History[$default]['Kashmir_today_desc'];  ?>
