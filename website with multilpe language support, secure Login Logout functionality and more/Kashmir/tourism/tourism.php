...
tr td:first-child {padding-left:0px;}
 ...
 #col3{padding:0px 0px 10px 50px; }
		...
		<div id = "mainpage"class="content">
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li>
					...
					<div class="sdt_box">
							<a href="../History/history.php"><?php echo $Home[$default]['history']  ?></a>
							<a href="#"><?php echo $Home[$default]['tourism']  ?></a>
	...
	<div class = "whoiam" id = "id_whoIam">
	  <h1 id = "bioheading" ><?php  echo $tourism[$default]['tourism']; ?></h1>
	  <hr />
	  <p id = "desc"> <?php  echo $tourism[$default]['tourism_desc']; ?>	  
	  ...
	  <h1 id = "bioheading" >  <?php  echo $tourism[$default]['jammu']; ?> </h1>
	  <hr />
	  <p id = "desc"> 
	

<?php  echo $tourism[$default]['jammu_desc']; ?>
	  </p>
	   <h1 id = "bioheading" ><?php  echo $tourism[$default]['Lakes_and_forts']; ?></h1>
	  <hr />
	  <p id = "desc">


<?php  echo $tourism[$default]['Lakesandforts_desc']; ?>
</p>	

 <h1 id = "bioheading" ><?php  echo $tourism[$default]['kashmir']; ?></h1>
	  <hr />
	  <p id = "desc">


<?php  echo $tourism[$default]['Kashmir_desc']; ?>


</p>	

<h1 id = "bioheading" ><?php  echo $tourism[$default]['Placeofinterset']; ?></h1>
	  <hr />
	  <p id = "desc">


<?php  echo $tourism[$default]['placeofinteresr_desc']; ?>

</p>	

<h1 id = "bioheading" ><?php  echo $tourism[$default]['Historical_Significance']; ?></h1>
	  <hr />
	  <p id = "desc">



<?php  echo $tourism[$default]['Historical_significance_desc']; ?>

</p>	

<h1 id = "bioheading" ><?php  echo $tourism[$default]['Ladakh_h1']; ?></h1>
	  <hr />
	  <p id = "desc">



<?php  echo $tourism[$default]['Ladakh_desc']; ?>
</p>	
